...
var ResourceManagerUiComponent = (function () {
    function ResourceManagerUiComponent(resolver) {
        this.resolver = resolver;
    }
    ResourceManagerUiComponent.prototype.ngOnInit = function () {
                            ...
                            items: [{
                                    ...
                                    items: [{
                                            ...
                                            initContent: function () {
                                                var beamSchedule = new beam_schedule_component_1.BeamScheduleComponent(new core_1.ElementRef(document.getElementById('dynamicBeamSchedule')));
                                    ...
                                    items: [{
                                            ...
                                            initContent: function () {
                                                var beamMap = new beam_map_component_1.BeamMapComponent(new core_1.ElementRef(document.getElementById('dynamicBeamMap')));
    ...
    ResourceManagerUiComponent.prototype.initRibbonControl = function () {
        ...
        function ejRibbonCollapse(args) {
            ...
            var ribbonHeight = parseInt($('#defaultRibbon').css("height"), 10);
            if (ribbonHeight < 50) {
    ...
    return ResourceManagerUiComponent;
}());
ResourceManagerUiComponent = __decorate([
    core_1.Component({
        ...
        entryComponents: [beam_schedule_component_1.BeamScheduleComponent, beam_map_component_1.BeamMapComponent]
    }),
    __metadata("design:paramtypes", [core_1.ComponentFactoryResolver])
], ResourceManagerUiComponent);
exports.ResourceManagerUiComponent = ResourceManagerUiComponent;
//# sourceMappingURL=resource-manager-ui.component.js.map